...
% ── Metadatos ──────────────────────────────────────────────
\title{{\fontsize{56}{62}\selectfont\textbf{HapticVision AI}}}
...
\begin{block}{Introducción}
  ...
  \medskip
  \imgplaceholder[40cm]{Prototipo del sistema}
\end{block}
\bigskip
...
\begin{block}{Arquitectura y Diseño}
  ...
  \begin{tikzpicture}[
    ...
    box/.style={draw=gray!50,fill=gray!8,rounded corners=4pt,
                text width=3.5cm,align=center,minimum height=1.1cm,font=\small},
    arr/.style={->,thick,gray!55}]
    \node[box](tof){ToF VL53L1X};
    \node[box,right=of tof](imu){IMU MPU-6050};
    \node[box,below=0.9cm of tof,xshift=1.75cm](ard){Arduino Nano\\{\footnotesize PID + I²C}};
    \node[box,below=1cm of ard](rpi){Raspberry Pi 4\\{\footnotesize YOLOv8 + APF}};
    \node[box,below=1cm of rpi](hap){Matriz Háptica\\{\footnotesize 6 motores ERM}};
