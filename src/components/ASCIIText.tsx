...
class AsciiFilter {
  ...
  constructor(
    renderer: THREE.WebGLRenderer,
    { fontSize = 12, fontFamily = "'Courier New', monospace", charset, invert }: {
...
class CanvAscii {
  ...
  setRenderer() {
    ...
    // Gradient gradient on the pre text
    this.filter.pre.style.backgroundImage =
      "radial-gradient(circle, #6366f1 0%, #8b5cf6 50%, #06b6d4 100%)"
    this.filter.pre.style.webkitTextFillColor = "transparent"
    ;(this.filter.pre.style as any).webkitBackgroundClip = "text"
    ...
    <>
      <style>{`
        ...
        .ascii-text-container pre {
          ...
          text-align: left;
          position: absolute; left: 0; top: 0;
          background-image: radial-gradient(circle, #6366f1 0%, #8b5cf6 50%, #06b6d4 100%);
